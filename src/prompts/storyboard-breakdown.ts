...
${beatExample}
      ...
      "state_ledger": {
        "_note": "Track only real hero/interacted entities that matter to causality, up to the project's configured 3-6 entity budget. state/from/to mean INTRINSIC physical condition only (temperature, fullness, integrity, wet/dry, open/closed); NEVER put location, 'on table', contact, possession, 'face up' or 'face down' there. Location belongs in position; possession in holder; facing/rotation in orientation. A touch with no persistent result keeps all four dimensions unchanged. Passive lawful physics such as exposed warm water gradually cooling uses caused_by='ambient heat exchange over elapsed story time'; it does not require character contact. Never invent filler entities.",
