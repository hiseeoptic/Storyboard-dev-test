...
export interface NanoFlowShot {
  ...
  /** Explicit execution mode for extensions. Kept in addition to the optional
   * end prompt so a user-forced two-frame shot cannot be silently collapsed. */
  frame_mode?: "start" | "start_end";
