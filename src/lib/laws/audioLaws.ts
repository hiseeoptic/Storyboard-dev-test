...
export const CONTEXTUAL_VOICE_RENDER_LOCK =
  "VOICE RENDER LOCK: use the exact language, regional accent and dialect declared by the locked project context or character voice profile; never invent a regional default. Keep speaker identity, apparent age, gender, timbre and natural pitch range stable across clips. Deliver context-appropriate emotion with real breath, phrase stress, pauses and sentence-final cadence — subtle in intimacy, strained in fear, sharp in conflict, energetic in comedy — without robotic, announcer-like or unmotivated theatrical delivery. Keep clean intelligible speech, one voice at a time, with low spatially credible location ambience.";
...
export const audioLaws = {
  ...
  laws: [
    ...
    "PROSODY is native and story-responsive: natural phrase stress, breath, pauses and sentence-final cadence at the locked rate; intensity may rise for fear, conflict, urgency or comedy, but never becomes announcer, advertisement, robotic or unmotivated overacting",
