...
export const cameraLaws = {
  ...
  laws: [
    ...
    "ONE motivated camera move or supported hold per clip, paced to the story (measured for intimacy, responsive for danger) — never combine a big camera move with big subject motion",
