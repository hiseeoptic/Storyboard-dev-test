...
export const CONTEXT_DNA_LAYERS: readonly {
  ...
  },
  {
    ...
    rule: "Character design must match the locked character type, world context, genre, culture, time period, and narrative role. Every recurring photoreal human keeps a stable identity system (role, age, class, occupation, personality, motivation, fear, relationships) and a locked appearance: whole-face topology and natural asymmetry; living age-appropriate skin microtexture; anatomical eyes/eyelids; individual eyebrow and upper/lower eyelash patterns; nose/lips; hairline, density and strand texture; body, outfit, accessories and stylization level. Behavior, posture, gestures, expression, speech rhythm, emotional response and social interaction must match the locked identity and culture. No drift unless a transformation arc is explicitly defined.",
    variables:
      "character ID, type/species, name, age range, gender, cultural fit, era fit, social role, occupation, personality, emotional baseline, motivation, fear/flaw, relationship map, face topology/asymmetry, skin microtexture, eye/eyelid, eyebrow, eyelash, nose/lip, hairline/strand, body/outfit/accessory/behavior/voice DNA, transformation arc, forbidden drift",
    violations:
