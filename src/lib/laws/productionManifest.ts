...
export function lawsForVeoJson(): Record<string, unknown> {
  return {
    ...
    // Includes causal-chain / prop-existence / cause-before-effect / one-location.
    action: PRODUCTION_LAWS.action_continuity_laws.laws.slice(0, 8),
