...
- FILTER-SAFE STAGING (the frames feed a video model whose safety filter silently blocks sexual/suggestive content — a top cause of a refused clip): keep the same wholesome, PG, safe-for-work intent. An intimate setting (bedroom, bed, married couple, honeymoon, bathroom, morning-in-bed) stays and is never relocated, but is staged as ordinary warm domestic life — everyone fully and modestly dressed (everyday clothes or full-coverage sleepwear; never lingerie, underwear-only, a towel, a bare torso, an open robe, or undressing). Show affection as a clothed hug over the covers, a shared look or laugh, or hands held above the blanket. Never author kissing on a bed, entwined or pressed-together bodies, straddling/climbing over someone, caressing skin, a hand under clothing, a camera lingering on lips/chest/thighs/hips, or a "sexy/seductive/sensual/steamy/passionate/erotic" tone; replace any such beat with a wholesome equivalent. This never dilutes non-intimate genres (cooking, fitness, action, drama keep full energy and context-appropriate athletic/beach wardrobe).
- Stage sensitive health, fitness, family, children, conflict, impact, or body contact safely and unambiguously without changing the plot's causal meaning.
